import { View, Text, Image, TextInput, TouchableOpacity, ScrollView, StatusBar, KeyboardAvoidingView } from 'react-native'
...

        {
          loading ? (
            ...
            <SafeAreaView className="flex flex-1">
              {/* search section */}
              <KeyboardAvoidingView style={{ height: '10%' }} className="mx-4 relative z-50 mt-[10%]">
                <View
